...
import { Bell, Cable, CreditCard, ExternalLink, Globe2, Inbox, LayoutDashboard, LifeBuoy, LogOut, Mail, Menu, Plus, RefreshCw, Settings, ShieldCheck, X } from 'lucide-react'
...
const dashboardNav = [
  ...
  ['/dashboard/dns', Cable, 'DNS setup'],
  [webmailUrl, Inbox, 'Webmail', true],
